...
function ProjectsPreview() {
  return (
    <div className="relative md:mx-8 md:my-40 md:h-auto h-[calc(100vh-7rem)] col-span-10 flex flex-col items-center overflow-y-auto">
      ...
      <div className="w-[calc(100%) md:w-[calc(100%-12rem) flex flex-col flex-1 justify-start text-white text-lg px-9 ">
        ...
        <div className="grid grid-cols-12 gap-5">
          ...
          <div className="col-span-12 md:col-span-6 bg-jet-2 text-white overflow-hidden sm:mx-0">
          ...
          <div className="col-span-12 md:col-span-6 bg-jet-2 text-white sm:mx-0">
            <div className="p-3 border-b border-white/10">
