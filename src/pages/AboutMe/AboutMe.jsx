        ...
        <div className="bg-jet-2 col-span-10 flex flex-col items-center min-h-screen text-white">
            ...
            <div className="w-2/3 p-9 text-xl">
                ...
                <div className="bg-jet p-6  shadow-md mb-8">
                    <p>
                        Passionate <span className="font-bold text-rosy">Full Stack Developer</span>{" "}
                        specializing in{" "}
                ...
                <div className="bg-jet p-6  shadow-md mb-8">
                    ...
                    <ul className="list-none space-y-3">
                        <li className="mb-2">
                            <span className="font-bold text-rosy">Frontend:</span> HTML, CSS, Bootstrap,
                            JavaScript (Vanilla & jQuery), React
                        </li>
                        <li className="mb-2">
                            <span className="font-bold text-rosy">Backend:</span> PHP, Laravel, MySQL
                        </li>
                        <li className="mb-2">
                            <span className="font-bold text-rosy">Tools:</span> Git, GitHub, Composer,
                            NPM
                        </li>
                        <li>
                            <span className="font-bold text-rosy">API & AI:</span> OpenAI API, Hugging
                            Face AI
                        </li>
                    </ul>
                </div>
